...
namespace GroupDocs.Conversion.Cloud.Examples.CSharp.LoadOptionsByDocumentType.Txt
{
    /// <summary>
    ...
    public class ConvertTxtByControllingLeadingSpacesBehavior
    {
        public static void Run()
        {
            try
            {
                ...
                {
                    LeadingSpacesOptions = TxtLoadOptions.LeadingSpacesOptionsEnum.ConvertToIndent,
